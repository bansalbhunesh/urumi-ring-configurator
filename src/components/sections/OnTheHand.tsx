...
/* ----------------------------------------------------------------------------
   "See it on the hand" — cinematic line-art editorial.

   A large hand illustration in the SVG language of the rest of the story —
   no external 3D runtime, no loading state, no robot. The ring band colour
   follows the live configurator selection. It declares data-ring="hidden"
   so the global ring (Scene.tsx) steps aside while this section owns the frame.
---------------------------------------------------------------------------- */
...
export function OnTheHand() {
  ...
  return (
    ...
    >
      {/* warm centre glow behind the hand */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 58% 64% at 68% 52%, rgba(195,155,65,0.11) 0%, transparent 70%)",
        }}
        aria-hidden
      />
