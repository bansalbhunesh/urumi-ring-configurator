...
/* ----------------------------------------------------------------------------
   ACT VI — Hidden precision.

   The ring turns into a living blueprint: the band, the raised setting and the
   stone resolve as an annotated technical drawing — diameters, the table angle,
   the carat — drawn on stroke-by-stroke as the section enters view. The point:
   luxury isn't decoration, it's precision. Pure SVG + Framer (no 3D/GPU), so it
   reads crisply everywhere and reflects the live centre stone.
---------------------------------------------------------------------------- */
...
export function Blueprint() {
  ...
  return (
    ...
    >
      ...
      <motion.svg
        viewBox="0 0 460 420"
        className="mt-12 w-full max-w-xl text-gold"
        fill="none"
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        {/* raised setting — prongs lifting the stone clear of the band */}
        ...
        {/* the stone — table + crown + pavilion, a brilliant in section */}
        ...
        {/* diameter dimension line (left) with end ticks */}
        ...
        {/* band-width dimension (bottom right) */}
