    ...
    <section id="materials" className="px-6 py-28 sm:px-10 lg:py-40">
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
        <div>
          ...
          <SplitText className="font-display mt-4 text-4xl leading-tight sm:text-5xl">
        ...
        <div>
          ...
          <SplitText delay={0.1} className="font-display mt-4 text-4xl leading-tight sm:text-5xl">
